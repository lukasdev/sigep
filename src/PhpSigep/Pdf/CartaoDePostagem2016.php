...
class CartaoDePostagem2016
{
    ...
    private function _render ($dest='', $fileName= '')
    {
        ...
        while (count($objetosPostais)) {
            ...
            for ($area = 0; $area < 1; $area++) {
                ...
                $this->pdf->SetXY(0, 25);
                /*echo '<pre>';
                var_dump($objetoPostal->getDestino()->getNumeroNotaFiscal());
                die;*/
                ...
                $this->pdf->SetXY(0, $this->pdf->GetY() + 10);
            ...
            $this->writeRemetente(0,  $this->pdf->GetY() + $hCepBarCode - 4, $wAddressLeftCol, $this->plp->getRemetente());
        }
    ...
    private function writeDestinatario ($l, $t, $w, $objetoPostal)
    {
        ...
        $this->pdf->Rect($l+2, $t1, 96, $t - $t1 + 25);
